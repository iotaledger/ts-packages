    ...
    return (
        <div className="relative">
            ...
            <button
                ...
                className="absolute right-4 top-1/2 -translate-y-1/2 p-xs text-iota-neutral-40 hover:text-iota-neutral-10 dark:text-iota-neutral-60 dark:hover:text-iota-neutral-92"
                aria-label="Dismiss"
            >
