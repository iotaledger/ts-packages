...
-   Updated dependencies [2903277]
    ...
    -   @iota/iota-names-sdk@2.0.1
    -   @iota/wallet-standard@0.4.5
...
-   01c5ae3: Update @iota/names-sdk to 0.6.1
...
-   Updated dependencies [9d88461]
    ...
    -   @iota/wallet-standard@0.4.1

## 0.9.0

### Minor Changes

-   e8ecc5f: Fix chain state not syncing when network changes in WalletProvider

### Patch Changes

-   00046c7: Update `@iota/iota-names-sdk` to `v0.5.1`
-   c599ba2: Ensure wallet-icon is a non-empty string before rendering
