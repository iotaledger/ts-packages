...
export class ProtoConversionError extends GrpcError {
...
export class SignatureConversionError extends GrpcError {
    constructor(detail: string) {
...
export class EmptyRequestError extends GrpcError {
    constructor() {
...
export class UnexpectedEndOfStreamError extends GrpcError {
    constructor() {
